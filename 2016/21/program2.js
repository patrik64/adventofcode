...
function moveReverse(str, inst)
{
    var arr = str.split('');
    var idx2 = Number(inst.param1);
    var idx1 = Number(inst.param2);
...
function rotateReverse(str, inst)
{
    var ret = [];
    for(var i = 0; i < str.length; i++)
    {
        var idx = i+1;
        var instTest = { "op" : "rotate", "param1":"right", "param2" : idx.toString()};
        var strTest1 = rotate(str, instTest);
        var strTest2 = rotate(strTest1, inst);
...
allInst = allInst.reverse();

for(var i in allInst)
{
    var obj = allInst[i];

    if(obj.op == "move")
        str = moveReverse(str, obj);
    else if(obj.op == "swap")
        str = swapReverse(str, obj);
    else if(obj.op == "rotate")
        str = rotateReverse(str,obj);
