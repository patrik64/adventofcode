...
//for max number that means d1 = 4 and d14 = 9
//from instructions we can read that d13 - d2 = 4
//for max number that means d2 = 5 and d13 = 9
...
for(let i3 = 9; i3 >=1; i3--) {
  for(let i4 = 9; i4 >=1; i4--) {
    for(let i5 = 9; i5 >=1; i5--) {
      for(let i6 = 9; i6 >=1; i6--) {
        for(let i7 = 9; i7 >=1; i7--) {
          for(let i8 = 9; i8 >=1; i8--) {
            for(let i9 = 9; i9 >=1; i9--) {
              for(let i10 = 9; i10 >=1; i10--) {
                let test = 45999999999199;
